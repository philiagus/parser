...
use Philiagus\Parser\BooleanPrimitive;
use PHPUnit\Framework\TestCase;

class BooleanPrimitiveTest extends TestCase
{

    public function testThatItExtendsBaseParser()
    {
        self::assertTrue((new BooleanPrimitive()) instanceof Parser);
    }
    ...
    {
        (new BooleanPrimitive())->parse($value);
    }
    ...
    {
        $result = (new BooleanPrimitive())->parse($value);
